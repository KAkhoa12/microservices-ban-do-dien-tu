...
urlpatterns = [
    ...
    path('api/get-user-with-token/', views.get_user_with_token, name='get_user_with_token'),
    ...
    path('profile/update/<int:user_id>', views.update_user, name='profile_update'),
    ...
    path('test-auth/', views.test_auth_page, name='test_auth'),

    # Cart routes
    path('add-to-cart/<int:id>/', views.add_to_cart_view, name='add_to_cart'),
    path('remove-from-cart/<int:id>/', views.remove_from_cart_view, name='remove_from_cart'),
    ...
    path('api/cart-data/', views.get_cart_data_api, name='get_cart_data_api'),

    # Order routes
    path('orders/', views.orders_page, name='orders'),
    path('order-history/', views.orders_page, name='order_history'),  # Alias cho order history
    path('order/<int:order_id>/', views.order_detail_page, name='order_detail'),

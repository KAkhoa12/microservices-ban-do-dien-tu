...
CONFIG = {
    ...
    'return_url': 'http://localhost:3000/payment/momo/result/',  # URL nhận kết quả từ MoMo qua Kong
    'notify_url': 'http://localhost:8000/api/payment/momo/ipn/',  # URL để MoMo gửi IPN (Instant Payment Notification)
